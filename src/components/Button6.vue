...
<template>
  <div id="buttonContainer">
    <a class="button big blue" href="javascript:;">Big Button</a>
    <a class="button big green" href="javascript:;">Big Button</a>
    <a class="button big orange" href="javascript:;">Big Button</a>
    <a class="button big gray" href="javascript:;">Big Button</a>

    <a class="button blue medium" href="javascript:;">Medium Button</a>
    <a class="button green medium" href="javascript:;">Medium Button</a>
    <a class="button orange medium" href="javascript:;">Medium Button</a>
    <a class="button gray medium" href="javascript:;">Medium Button</a>

    <a class="button small blue" href="javascript:;">Small Button</a>
    <a class="button small green" href="javascript:;">Small Button</a>
    <a class="button small blue rounded" href="javascript:;">Rounded</a>

    <a class="button small orange" href="javascript:;">Small Button</a>
    <a class="button small gray" href="javascript:;">Small Button</a>

    <a class="button small green rounded" href="javascript:;">Rounded</a>
  </div>
</template>
...
.green.button {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(162, 211, 30, 1) 0, rgba(
            162,
            211,
            30,
            0
          ...
          100px),
    -moz-linear-gradient(#82cc27, #74b317);
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
...
.green.button:hover {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(183, 229, 45, 1) 0, rgba(
            183,
            229,
            45,
            0
...
.orange.button {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(232, 189, 45, 1) 0, rgba(
            232,
            189,
            45,
            0
...
.orange.button:hover {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(241, 192, 52, 1) 0, rgba(
            241,
            192,
            52,
            0
...
.gray.button {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(197, 199, 202, 1) 0, rgba(
            197,
            199,
            202,
            0
...
.gray.button:hover {
  ...
  background-image: url('./../assets/button_bg.png'),
    url('./../assets/button_bg.png'),
    -moz-radial-gradient(center bottom, circle, rgba(202, 205, 208, 1) 0, rgba(
            202,
            205,
            208,
            0
